...
{
    public partial class UserAppointment : UserControl
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in Program.cargoInfos)
            {
                ...
                {
                    MessageBox.Show("Takip no boş bırakılamaz.");
                    return;
                }
                foreach (char chr in textBoxTrackNo.Text)
                {
                    if (!Char.IsNumber(chr))
                    {
                        MessageBox.Show("Kargo takip no sadece sayılardan oluşmalı.");
                        return;
                    }
                }
        ...
        private void textBoxTrackNo_KeyPress(object sender, KeyPressEventArgs e)
        {
